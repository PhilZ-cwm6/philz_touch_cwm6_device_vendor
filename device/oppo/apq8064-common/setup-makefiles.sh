...
LINEEND=" \\"
COUNT=`wc -l ../apq8064-common/proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../apq8064-common/proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
...
LINEEND=" \\"
COUNT=`wc -l ../apq8064-common/common-proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../apq8064-common/common-proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
