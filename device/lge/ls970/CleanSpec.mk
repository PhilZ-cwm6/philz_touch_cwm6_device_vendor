...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/ls970/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/ls970/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/ls970/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/ls970/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/ls970/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/ls970/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/ls970/system/build.prop)
