...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := m8wlv
...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x02008000 --dt device/htc/m8vzw/recovery/dt.img --tags_offset 0x01e00000
TARGET_PREBUILT_KERNEL := device/htc/m8vzw/recovery/zImage-1.12.605.11
...
BOARD_EGL_CFG := device/htc/m8vzw/configs/egl.cfg
