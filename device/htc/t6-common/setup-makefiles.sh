...
LINEEND=" \\"
COUNT=`wc -l ../t6-common/proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../t6-common/proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
...
LINEEND=" \\"
COUNT=`wc -l ../t6-common/common-proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../t6-common/common-proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
